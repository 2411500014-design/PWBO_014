...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><?= isset($page_title) ? $page_title : 'Tambah Data Anak' ?></h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Form Tambah Data Anak</h3>
            </div>
            <?= form_open('anak/store') ?>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="ortu_id" name="ortu_id" required>
                  ...
                  <?php foreach($ortu_list as $ortu): ?>
                    <option value="<?= $ortu->id_ortu ?>" <?= set_value('ortu_id') == $ortu->id_ortu ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?= set_value('name') ?>" placeholder="Masukkan Nama Anak" required>
              </div>

              <div class="form-group">
                <label for="nik">NIK <span class="text-danger">*</span></label>
                <input type="number" class="form-control" id="nik" name="nik" value="<?= set_value('nik') ?>" placeholder="Masukkan NIK" required>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="bb_lahir" name="bb_lahir" value="<?= set_value('bb_lahir') ?>" placeholder="Contoh: 3.5" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="tb_lahir">Tinggi Badan Lahir (cm) <span class="text-danger">*</span></label>
                    <input type="number" step="0.01" class="form-control" id="tb_lahir" name="tb_lahir" value="<?= set_value('tb_lahir') ?>" placeholder="Contoh: 50.5" required>
                  </div>
                </div>
              </div>
