            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="fasilitas" name="fasilitas" required>
                  ...
                  <option value="Puskesmas" <?= set_value('fasilitas') == 'Puskesmas' ? 'selected' : '' ?>>Puskesmas</option>
                  <option value="Rumah Sakit" <?= set_value('fasilitas') == 'Rumah Sakit' ? 'selected' : '' ?>>Rumah Sakit</option>
                  <option value="Klinik" <?= set_value('fasilitas') == 'Klinik' ? 'selected' : '' ?>>Klinik</option>
                  <option value="Posyandu" <?= set_value('fasilitas') == 'Posyandu' ? 'selected' : '' ?>>Posyandu</option>
                </select>
              </div>
            </div>
