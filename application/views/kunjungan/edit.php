...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><?= isset($page_title) ? $page_title : 'Edit Data Kunjungan' ?></h1>
        </div>
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <?= form_open('kunjungan/update/'.$kunjungan->id_kunjungan) ?>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="anak_id" name="anak_id" required>
                  ...
                  <?php foreach($anak_list as $anak): ?>
                    <option value="<?= $anak->id_anak ?>" <?= ($kunjungan->anak_id == $anak->id_anak) ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="tgl_kunjungan" name="tgl_kunjungan" value="<?= set_value('tgl_kunjungan', $kunjungan->tgl_kunjungan) ?>" required>
              </div>
