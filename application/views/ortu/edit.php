...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><?= isset($page_title) ? $page_title : 'Edit Data Orang Tua' ?></h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name_ibu" name="name_ibu" 
                       value="<?= set_value('name_ibu', $ortu->name_ibu) ?>" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name_ayah" name="name_ayah" 
                       value="<?= set_value('name_ayah', $ortu->name_ayah) ?>" required>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="hubungan" name="hubungan" required>
                  ...
                  <option value="Orang Tua Kandung" <?= set_value('hubungan', $ortu->hubungan) == 'Orang Tua Kandung' ? 'selected' : '' ?>>Orang Tua Kandung</option>
                  <option value="Orang Tua Tiri" <?= set_value('hubungan', $ortu->hubungan) == 'Orang Tua Tiri' ? 'selected' : '' ?>>Orang Tua Tiri</option>
                  <option value="Wali" <?= set_value('hubungan', $ortu->hubungan) == 'Wali' ? 'selected' : '' ?>>Wali</option>
                  <option value="Lainnya" <?= set_value('hubungan', $ortu->hubungan) == 'Lainnya' ? 'selected' : '' ?>>Lainnya</option>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="telp" name="telp" 
                       value="<?= set_value('telp', $ortu->telp) ?>" required>
              </div>
