...
INSERT INTO `anak` (`id_anak`, `ortu_id`, `name`, `nik`, `jk`, `bb_lahir`, `tgl_lahir`, `tb_lahir`, `goldar`, `create_at`) VALUES
(1, 1, 'Doarn', 1978102839229191, 'Laki-laki', '3.00', '2012-03-02', '50.00', 'O', '2025-12-01 23:40:11');
...
INSERT INTO `kunjungan` (`id_kunjungan`, `anak_id`, `tgl_kunjungan`, `fasilitas`) VALUES
(1, 1, '2025-12-01', 'Puskesmas');
...
(1, 'random', 'monar', 'Orang tua tiri', '0812147483647', 'Jln. Sumatra Utara', '2025-12-01 23:27:52');
...
INSERT INTO `pengukuran` (`id_ukur`, `kunjungan_id`, `ortu_id`, `tgl_ukur`, `bb`, `tb`, `lk`, `vaksin`, `status_gizi`) VALUES
(1, 1, 0, '2025-12-03', '60.00', '159.00', '35.50', 'DPT', 'Gizi Baik');
...
--
ALTER TABLE `kunjungan`
  MODIFY `id_kunjungan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pengukuran`
  MODIFY `id_ukur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
